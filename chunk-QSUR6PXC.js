import{Ta as d,la as a}from"./chunk-ASJ7VWMC.js";var c={name:"Samiha Style Studio",address:"Uttara, Dhaka, Bangladesh",phone:"01993-095811",email:"samihamanager@gmail.com",website:"https://www.facebook.com/samihastylestudio"};var f=(()=>{class r{constructor(){this.isPrinting=d(!1),this.companyInfo=c}printReceipt(t){return this.isPrinting()?Promise.resolve():(this.isPrinting.set(!0),new Promise(i=>{let n=this.generateReceiptHTML(t,this.companyInfo),e=window.open("","_blank");if(!e){console.error("Failed to open print window"),this.isPrinting.set(!1),i();return}e.document.open(),e.document.write(n),e.document.close();let o=()=>{e.close(),this.isPrinting.set(!1),i()};e.onload=()=>{setTimeout(()=>{try{e.focus(),e.print(),e.onafterprint=o,setTimeout(()=>o(),3e3)}catch(s){console.error("Printing failed",s),o()}},100)}}))}generateReceiptHTML(t,i){return`
    <html>
      <head>
        <style>
          @page {
      ...
      <body>
        ...
        <div class="center">Date: ${t.created_on?new Date(t.created_on).toLocaleString():new Date().toLocaleString()}</div>
        <div class="line"></div>
  ...
  `}static{this.\u0275fac=function(i){return new(i||r)}}static{this.\u0275prov=a({token:r,factory:r.\u0275fac,providedIn:"root"})}}return r})();export{c as a,f as b};
